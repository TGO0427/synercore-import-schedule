  ...
  return (
    <div className="container">
      <div className="sidebar">
        ...
        <ul className="sidebar-nav">
          <li>
            <button 
              ...
              onClick={() => {
                console.log('Switching to shipping view');
        ...
        <div style={{ marginTop: '1rem', padding: '0.5rem', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: '6px', borderLeft: '3px solid rgba(255,255,255,0.3)' }}>
          <p style={{ fontSize: '0.8rem', opacity: 0.8 }}>Current View:</p>
          <p style={{ fontSize: '0.9rem', fontWeight: '500' }}>
            {activeView === 'shipping' ? '📦 Shipping Schedule' : '📋 Product & Warehouse'}
          </p>
        </div>
