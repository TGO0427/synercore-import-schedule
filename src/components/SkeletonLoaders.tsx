 ...
 */
export function SkeletonPulse({ width = '100%', height = '20px', borderRadius = '4px', className = '' }: SkeletonPulseProps) {
  return (
    <div
 ...
 */
export function SkeletonTableRow({ columns = 5, height = '50px' }: SkeletonTableRowProps) {
  return (
 ...
 */
export function SkeletonCardGrid({ count = 4, columns = 4 }: SkeletonCardGridProps) {
  return (
 ...
 */
export function SkeletonWrapper({ isLoading, skeleton: SkeletonComponent, children }: SkeletonWrapperProps) {
  if (isLoading) {
...
interface SkeletonShipmentTableProps {
  rows?: number;
}
 ...
 */
export function SkeletonShipmentTable({ rows = 10 }: SkeletonShipmentTableProps) {
  return (
