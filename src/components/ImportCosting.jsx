...
const INITIAL_FORM_STATE = {
  ...
  airfreight_rate_per_kg_usd: 0,
  airfreight_rate_per_kg_eur: 0,
  airfreight_origin_charges_usd: 0,
  airfreight_origin_charges_eur: 0,
  fuel_surcharge_per_kg_usd: 0,
  fuel_surcharge_per_kg_eur: 0,
  security_surcharge_per_kg_usd: 0,
  security_surcharge_per_kg_eur: 0,
  screening_fee_zar: 0,
  awb_fee_zar: 0,
