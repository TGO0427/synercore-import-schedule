...
export default async function addCostingColumns() {
  ...
  const airfreightColumns = [
    ...
    'airfreight_rate_per_kg_usd NUMERIC(12,2) DEFAULT 0',
    'airfreight_rate_per_kg_eur NUMERIC(12,2) DEFAULT 0',
    ...
    'fuel_surcharge_per_kg_usd NUMERIC(12,2) DEFAULT 0',
    'fuel_surcharge_per_kg_eur NUMERIC(12,2) DEFAULT 0',
    'fuel_surcharge_total_zar NUMERIC(14,2) DEFAULT 0',
    'security_surcharge_per_kg_usd NUMERIC(12,2) DEFAULT 0',
    'security_surcharge_per_kg_eur NUMERIC(12,2) DEFAULT 0',
    ...
    'airfreight_origin_charges_eur NUMERIC(12,2) DEFAULT 0',
